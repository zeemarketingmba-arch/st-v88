...
interface IconProps {
  name: 'dashboard' | 'subjects' | 'students' | 'settings' | 'add' | 'edit' | 'delete' | 'sun' | 'moon' | 'close' | 'print' | 'save' | 'logo' | 'sparkles' | 'download' | 'upload' | 'chart-bar' | 'info' | 'project';
  className?: string;
}

const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  // FIX: Corrected the type definition for the `icons` object to use `React.ReactNode` instead of `JSX.Element`. This resolves a "Cannot find namespace 'JSX'" error that can occur in certain TypeScript configurations.
  const icons: { [key in IconProps['name']]: React.ReactNode } = {
    ...
    subjects: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v11.494m-9-5.747h18" />,
    ...
    logo: <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25c-3.314 0-6-2.015-6-4.5 0-2.486 2.686-4.5 6-4.5s6 2.014 6 4.5c0 2.485-2.686 4.5-6 4.5zm0 0v6.75m-3.75-6.75h7.5" />,
    sparkles: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4m5 2l-1.5-5L10 2l-1.5 5L7 9l1.5 5 1.5-5 1.5 5 1.5-5zm9 6l-1.5-5L17 7l-1.5 5L14 14l1.5 5 1.5-5 1.5 5 1.5-5z" />,
    download: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />,
    upload: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0l-4 4m4-4v12" />,
    ...
    project: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />,
  };
